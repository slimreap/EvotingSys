          ...
          >
            ...
            <div>
              ...
              <input
                ...
                name="candidate-0-Candidate_Img"
                id="uploadphoto21"
                value=""
                accept="image/*"
              />
          ...
          >
            ...
            <div>
              ...
              <input
                type="file"
                class="user-photo-inp"
                name="candidate-1-Candidate_Img"
                id="uploadphoto1"
                value=""
                accept="image/*"
              />
          ...
          >
            ...
            <div>
              ...
              <input
                type="file"
                class="user-photo-inp"
                name="candidate-2-Candidate_Img"
                id="uploadphoto23"
                value=""
                accept="image/*"
              />
          ...
          >
            ...
            <div>
              ...
              <input
                type="file"
                class="user-photo-inp"
                name="candidate-3-Candidate_Img"
                id="uploadphoto3"
                value=""
                accept="image/*"
              />
          ...
          >
            ...
            <div>
              ...
              <input
                type="file"
                class="user-photo-inp"
                name="candidate-4-Candidate_Img"
                id="uploadphoto4"
                value=""
                accept="image/*"
              />
          ...
          >
            ...
            <div>
              ...
              <input
                type="file"
                class="user-photo-inp"
                name="candidate-5-Candidate_Img"
                id="uploadphoto5"
                value=""
                accept="image/*"
              />
          ...
          >
            ...
            <div>
              ...
              <input
                type="file"
                class="user-photo-inp"
                name="candidate-6-Candidate_Img"
                id="uploadphoto6"
                value=""
                accept="image/*"
              />
